...
export const Clips = ({clip, imgsrc}) => {
  return (
    ...
    <div className='bg-white blur-effect-theme absolute top-0 right-0 left-0 opcity-100 z-[100] w-8 h-8 md:w-5 md:h-5 flex items-center justify-center rounded-full '>
